...
fn get_install_info_with_subkey(subkey: String) -> (String, String, String, String) {
    ...
    let exe = format!("{}\\{}", path, crate::get_app_exe_filename());
...
fn get_before_uninstall(kill_self: bool) -> String {
    let app_name = crate::get_app_name();
    let ext = app_name.to_lowercase();
    let exe_name = crate::get_app_exe_filename();
...
if exist \"{tray_shortcut}\" del /f /q \"{tray_shortcut}\"
    ",
        app_name = crate::get_app_name(),
        exe_name = crate::get_app_exe_filename(),
        import_config = get_import_config(&exe),
        create_service = get_create_service(&exe),
    );
...
pub fn update_me(debug: bool) -> ResultType<()> {
    ...
    let app_exe_name = crate::get_app_exe_filename();
