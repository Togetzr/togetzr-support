...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(
        f'"{sys.executable}" ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/togetzr_support.exe')
    os.chdir('../..')
    ...
    os.rename('./rustdesk_portable.exe', f'./togetzr-support-{version}-install.exe')
    print(
        f'output location: {os.path.abspath(os.curdir)}/togetzr-support-{version}-install.exe')
