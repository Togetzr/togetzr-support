...
class MyTheme {
  ...
  static const Color accent = Color(0xFF45AADA); // Togetzr blue
  static const Color accent50 = Color(0x7745AADA);
  static const Color accent80 = Color(0xAA45AADA);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF45AADA);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF45AADA);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://togetzr.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
...
bool whitelistNotEmpty() {
  // https://togetzr.com/docs/en/self-host/client-configuration/advanced-settings/#whitelist
