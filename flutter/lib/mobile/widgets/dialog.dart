...
void showServerSettingsWithValue(
  ...
  final canEdit = !(idFixed || relayFixed || apiFixed || keyFixed);
    ...
    return CustomAlertDialog(
      title: Row(
        children: [
          ...
          if (canEdit) ...ServerConfigImportExportWidgets(controllers, errMsgs),
        ],
      ),
          ...
          child: Obx(() => Column(
                ...
                children: [
                  buildField(translate('ID Server'), idCtrl, idServerMsg.value,
                      autofocus: true, readOnly: idFixed),
                  SizedBox(height: 8),
                  if (!isIOS && !isWeb) ...[
                  ...
                  SizedBox(height: 8),
                  buildField('Key', keyCtrl, '', readOnly: keyFixed),
                  if (isInProgress)
                    Padding(
